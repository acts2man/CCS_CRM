...
export default function EditTeacherModal({ open, onOpenChange, teacher, onTeacherUpdated }) {
  ...
  useEffect(() => {
    if (teacher) {
      setFormData({
        ...
        employment_start: teacher.employment_start || "",
        status: teacher.status || "Active",
        homeroom: teacher.homeroom || "",
        education: teacher.education || "",
        biography: teacher.biography || "",
      });
      setPhotoUrl(teacher.avatar || "");
      setSelectedSubjects(teacher.subjects || []);
      setSelectedGradeLevels(teacher.grade_levels || []);
    }
  }, [teacher]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await base44.entities.Teacher.update(teacher.id, teacherData);
