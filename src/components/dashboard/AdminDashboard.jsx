      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
         <div className="flex items-center gap-4">
           ...
           <div>
             ...
             <p className="text-gray-600 mt-1">Welcome back, {user?.email === 'reputationanalysts@gmail.com' ? `Principal ${user?.full_name || user?.name}` : (user?.name || user?.full_name || 'Admin')}</p>
           </div>
         </div>
