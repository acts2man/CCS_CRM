...
import ParentSchoolCalendar from '@/pages/ParentSchoolCalendar';
import ParentForms from '@/pages/ParentForms';
import StudentBulletin from '@/pages/StudentBulletin';
import BulletinBoard from '@/pages/BulletinBoard';
import SchoolForms from '@/pages/SchoolForms';
...
const AuthenticatedApp = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/TeacherStudentProfile" element={<TeacherLayout><TeacherStudentProfile /></TeacherLayout>} />
